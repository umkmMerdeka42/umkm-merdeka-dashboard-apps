        ...
        <div className="flex flex-col justify-center h-full">
          <div className="w-full mr-[14px] bg-white shadow-lg rounded-sm border border-gray-200">
            <header className="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
              <h2 className="font-semibold text-[10px] w-20 md:w-full md:text-base lg:text-xl text-gray-800">Customers UMKM Merdeka</h2>
                  ...
                  <thead className="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                    <tr>
                      ...
                      <th className="px-2 whitespace-nowrap">
                        <div className="px-4 font-semibold text-left">Nama</div>
                      </th>
