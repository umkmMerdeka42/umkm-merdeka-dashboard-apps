...
const ListUser = () => {
  return (
    <div>
      <section className="max-w-[1000px] w-[970px] text-gray-600">
        <div className="flex flex-col justify-center h-full">
          <div className="w-full mr-[14px] bg-white shadow-lg rounded-sm border border-gray-200">
            <header className="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
              <h2 className="font-semibold text-gray-800">Customers UMKM Merdeka</h2>
                ...
                <table className="table-auto w-full">
                  <thead className="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                    <tr>
                      ...
                      <th className="py-2 whitespace-nowrap">
                        <div className="font-semibold text-left">No Telephone</div>
                      </th>
                      <th className="py-2 whitespace-nowrap">
                        <div className="font-semibold text-left">Universitas</div>
                      </th>
                      <th className="py-2 whitespace-nowrap">
                        <div className="font-semibold text-left">NIM / NPM</div>
                      </th>
                      <th className="py-2 whitespace-nowrap">
                    ...
                    <tbody className="text-sm divide-y divide-gray-100">
                      <tr>
                        ...
                        <td className="p-2 whitespace-nowrap">
                          <div className="text-left">M Aji Perdana</div>
                        </td>
                        <td className="py-2 whitespace-nowrap">
                          <div className="text-left">alexshatov@gmail.com</div>
                        </td>
                        <td className="py-2 whitespace-nowrap">
                          <div className="text-left">085695951121</div>
                        </td>
                        <td className="py-2 whitespace-nowrap">
                          <div className="text-left">Universitas Bandar Lampung</div>
                        </td>
                        <td className="py-2 whitespace-nowrap">
                          <div className="text-left">19411011</div>
                        </td>
                        <td className="py-2 whitespace-nowrap">
